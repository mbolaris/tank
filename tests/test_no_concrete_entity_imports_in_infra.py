...
INFRA_FILES = [
    ...
    "backend/routers/solutions/__init__.py",
    "backend/routers/solutions/catalog.py",
    "backend/routers/solutions/detail.py",
    "backend/routers/solutions/reports.py",
    "backend/routers/solutions/capture.py",
    "backend/routers/solutions/lifecycle.py",
    "backend/routers/worlds/__init__.py",
    "backend/routers/worlds/collection.py",
    "backend/routers/worlds/instance.py",
    "backend/routers/worlds/runtime.py",
    "backend/routers/worlds/telemetry.py",
    "backend/routers/worlds/mode.py",
