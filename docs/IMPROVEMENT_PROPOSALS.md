...
`-> Any`, `[Any]`) and **802 plain `Any` occurrences** across `core/`. Both
...
`dict[str, Any]`; a plain `\bAny\b` count is 802) and replace the easy ones
...
`core/simulation/debug_trace.py`, and `core/services/stats/selection_quality.py`.
