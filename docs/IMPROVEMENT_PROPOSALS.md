...
`-> Any`, `[Any]`) and **791 plain `Any` occurrences** across `core/`. Both
...
`dict[str, Any]`; a plain `\bAny\b` count is 791) and replace the easy ones
...
`core/genetics/trait.py`, and `core/simulation/event_managers.py`.
