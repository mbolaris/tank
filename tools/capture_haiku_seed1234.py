...
def capture_and_eval(world):
    ...
    solution = tracker.capture_solution(best_fish, name="Haiku-4.5 Poker Stratege", description="75k frames seed 1234", author="Haiku-4.5")
    ...
    logger.info(f"SEED 1234: Elo {result.elo_rating:.0f}, Tier {result.skill_tier}, bb/100 {result.weighted_bb_per_100:+.2f}")
