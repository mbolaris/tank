...
class GTOExpertStrategy(PokerStrategyAlgorithm):
    ...
    def __init__(self, rng: Optional[random.Random] = None):
        ...
        super().__init__(
            ...
            parameters={
                ...
                "defensive_bandwidth": _rng.uniform(
                    0.8, 1.0
            ...
            if adjusted_strength >= defense_threshold:
                ...
                if adjusted_strength > 0.85:
                    ...
                    if self._rng.random() < raise_freq:
                        return self._get_value_raise(
                            pot, player_energy, call_amount, adjusted_strength
                        )
    ...
    def _get_value_raise(
        ...
        raise_amt = min(
            raise_amt, player_energy * 0.5
        )  # Don't commit > 50% stack in one go unless all-in
