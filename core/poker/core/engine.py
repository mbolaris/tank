...
class PokerEngine:
    ...
    def evaluate_hand(hole_cards: List[Card], community_cards: List[Card]) -> PokerHand:
        ...
        return PokerEngine.evaluate_hand_cached(hole_key, community_key)
    ...
    def evaluate_hand_cached(hole_key: Tuple[int, ...], community_key: Tuple[int, ...]) -> PokerHand:
        ...
        if n_cards < 5:
            ...
            description = f"High Card {PokerEngine._rank_name(top_rank)}"
        ...
        if n_cards == 5:
            ...
            return PokerEngine._evaluate_five_cards_cached(five_sorted)
        ...
        for five in combinations(all_sorted, 5):
            ...
            hand = PokerEngine._evaluate_five_cards_cached(key)
