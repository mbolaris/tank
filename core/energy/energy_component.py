...
from core.config.fish import (BABY_METABOLISM_MULTIPLIER,
                              CRITICAL_ENERGY_THRESHOLD_RATIO,
                              ELDER_METABOLISM_MULTIPLIER,
                              EXISTENCE_ENERGY_COST, EXISTENCE_SIZE_EXPONENT,
                              INITIAL_ENERGY_RATIO, LOW_ENERGY_THRESHOLD_RATIO,
                              MOVEMENT_ENERGY_COST, MOVEMENT_SIZE_EXPONENT,
                              SAFE_ENERGY_THRESHOLD_RATIO, SPRINT_ENERGY_COST,
                              SPRINT_THRESHOLD, STARVATION_THRESHOLD_RATIO)
