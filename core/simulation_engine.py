...
class SimulationEngine(BaseSimulator):
    ...
    def _build_simulation_metadata(self) -> Dict[str, Any]:
    ...
    def _build_population_summary(self) -> Dict[str, Any]:
    ...
    def _build_algorithm_performance(self, algorithm_metadata: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _build_poker_statistics(self) -> Dict[str, Any]:
    ...
    def _build_generation_trends(self) -> List[Dict[str, Any]]:
    ...
    def _identify_worst_performers(self) -> List[Dict[str, Any]]:
    ...
    def _identify_extinct_algorithms(self) -> List[Dict[str, Any]]:
    ...
    def export_stats_json(self, filename: str) -> None:
        ...
        export_data = {
            ...
            "population_summary": self._build_population_summary(),
            "death_causes": dict(self.ecosystem.death_causes),
            "algorithm_registry": algorithm_metadata,
            "algorithm_performance": self._build_algorithm_performance(algorithm_metadata),
            "poker_statistics": self._build_poker_statistics(),
            "generation_trends": self._build_generation_trends(),
            "recommendations": {
                "top_performers": self._identify_top_performers(),
                "worst_performers": self._identify_worst_performers(),
                "extinct_algorithms": self._identify_extinct_algorithms(),
            },
        }
