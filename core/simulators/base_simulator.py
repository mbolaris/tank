...
class BaseSimulator(ABC):
    ...
    def handle_collisions(self) -> None:
        ...
        Processes fish-to-fish and fish-to-food collisions.
        Mixed poker games (fish + plants) are handled separately by
        PokerSystem.handle_mixed_poker_games(), which includes throttling.
        """
        self.handle_fish_collisions()
        self.handle_food_collisions()
        # Mixed poker handles both fish-plant and plant-plant interactions
        # Throttling is handled inside handle_mixed_poker_games()
    ...
    def handle_mixed_poker_games(self) -> None:
        ...
        Base implementation does nothing. Override in SimulationEngine
