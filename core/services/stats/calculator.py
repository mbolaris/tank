...
- (genetic/behavior stats remain inline for now)

Architecture Notes:
- Split from original 1,277-line monolith
- Delegates to sub-modules where practical
- Complex genetic distribution logic kept inline initially
"""
...
class StatsCalculator:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # Add genetic distribution stats (kept inline for now)
