...
# =============================================================================
# Legacy action support (deprecated, will be removed)
# =============================================================================


@dataclass(frozen=True)
class LegacySoccerAction:
    """Legacy action format with move_target/face_angle.

    DEPRECATED: Use SoccerAction instead. This exists only for backward
    compatibility during migration.
    """

    move_target: Vector2D | None = None
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> LegacySoccerAction:
        move_target = None
