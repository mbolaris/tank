"""Tank-like entity identity provider for Fish/Plant/Food worlds.

This module provides stable entity identities for Tank-like world entities,
...
class TankLikeEntityIdentityProvider:
    """Identity provider for Tank-like entities using stable ID offsets.
