"""Tank-specific phase hooks for Fish/Plant/Food entity handling.

This module extracts the Tank-specific entity handling logic that was
previously embedded in SimulationEngine phase methods. By moving this
logic into hooks, new modes like Soccer can provide their own entity
handling without modifying engine code.
"""
...
class TankPhaseHooks(PhaseHooks):
    """Tank-specific phase behavior for Fish/Plant/Food entities.
