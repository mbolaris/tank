...
class SoloFishMovement(MovementStrategy):
    def move(self, sprite):
        ...
        sprite.avoid(sprite.environment.get_agents_of_type(Crab), 200)
        sprite.align_near(sprite.environment.get_agents_of_type(Food), 0)
...
class SchoolingFishMovement(MovementStrategy):
    def move(self, sprite):
        ...
        schooling_fish_sprites = [other_sprite for other_sprite in sprite.environment.get_agents_of_type(Fish)
        ...
        # Avoid single fish
        solo_fish_sprites = [other_sprite for other_sprite in sprite.environment.get_agents_of_type(Fish)
                             if other_sprite.animation_frames != sprite.animation_frames]
